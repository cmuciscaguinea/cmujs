<html lang="en" style="height: auto;"><head>
  ...
  <link
      ...
      type="image/png"
      sizes="16x16"
      href="<?php echo base_url("assets/dist/img/jslogo1.png")?>"
    />
  <!-- DataTables -->
...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white" style="background-color: #f1bd07">
    <div class="container">
      <a href="<?php echo site_url('generals') ?>" class="navbar-brand">
        <img src="<?php echo base_url()?>assets/dist/img/jslogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li style="vertical-align:middle" class="nav-item">
            <a href="<?php echo base_url('volumes_general'); ?>" class="nav-link text-bold">Volumes</a>
          </li>
      ...
      <ul class="navbar-nav  ml-auto">
        <?php if(!$this->session->userdata('signedin')) : ?>
          <li class="nav-item">
            <a href="<?php echo base_url('signup') ?>" class="nav-link text-bold">Register</a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url('signin') ?>" class="nav-link text-bold">Login</a>
          </li>
        <?php endif; ?>

        <?php if($this->session->userdata('signedin')) : ?>
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>generals/signout" class="nav-link text-bold">Log Out</a>
          </li>
        <?php endif; ?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #005500">
    <!-- Brand Logo -->
