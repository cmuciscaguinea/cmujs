          ...
          <div class="col-xl-7 col-xxl-8">
            <a href="home" class="text-nowrap logo-img d-block px-4 py-9 w-100">
              ...
              <span class="logo-text">
                <!-- dark Logo text -->
                <img src="./assets/images/journal.jpg" alt="homepage" class="dark-logo ps-2" />
                <!-- Light Logo text -->
                <img src="./assets/images/journal.jpg" class="light-logo ps-2" alt="homepage" />
              </span>
            </a>
          ...
          <div class="col-xl-5 col-xxl-4">
            <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
              <div class="auth-max-width col-sm-8 col-md-6 col-xl-9">
                <h2 class="mb-1 fs-7 fw-bolder">Welcome to CMU Journal of Science</h2>
                ...
                <form action="" method="post">
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-medium">New to User?</p>
