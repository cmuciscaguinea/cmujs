        ...
        <div class="container">
          <nav class="navbar navbar-expand-md navbar-light ps-0">
            ...
            <a class="navbar-brand" href="<?php echo base_url("")?>">
              ...
              <img src="./assets/images/journal.jpg" alt="logo" />
            </a>
                  ...
                  <div class="d-flex flex-row">
                    <div class="me-4">
                      <div class="banner-img-1 slideup">
                        <img src="./assets/images/js1.png" alt="" class="img-fluid" />
                      </div>
                      <div class="banner-img-1 slideup">
                        <img src="./assets/images/js2.png" alt="" class="img-fluid" />
                      </div>
                    </div>
                    <div class="">
                      <div class="banner-img-2 slideDown">
                        <img src="./assets/images/js3.png" alt="" class="img-fluid" />
                      </div>
                      <div class="banner-img-2 slideDown">
                        <img src="./assets/images/js4.png" alt="" class="img-fluid" />
                      </div>
                    </div>
                  </div>
                </div>
