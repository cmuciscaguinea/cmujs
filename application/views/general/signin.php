...
<?php if($this->session->flashdata('signedin_failed')): ?>
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>CMU Journal</b><br>Login</a>
    </div>
    <div class="card-body">
      ...
      <br>
      <p class="mb-0">
      Don't have an account?<a href="<?php echo site_url('generals/signup'); ?>" class="text-center"> Register Here </a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
